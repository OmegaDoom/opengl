            ...
            , 0.0019f }
{
    ...
    //AddSceneObject<MaterialDrawable>(*this, 0);
    //AddSceneObject(modelLoader.Load(*this, "nanosuit/nanosuit.obj"));
    AddSceneObject(modelLoader.Load(*this, "backpack/backpack.obj"));
    //AddSceneObject(modelLoader.Load(*this, "bob/boblampclean.md5mesh"));
    //AddSceneObject(modelLoader.Load(*this, "spider/Only_Spider_with_Animations_Export.dae"));
    //AddSceneObject(modelLoader.Load(*this, "model.nff"));
...
void Scene::Update()
{
    ...
    for (unsigned i = 0; i < m_pointLights.size(); ++i)
    {
