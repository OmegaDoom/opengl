...
subroutine vec3 SubroutineGetNormal();

layout(index = 0) subroutine (SubroutineGetNormal) vec3 getNormal()
{
    return normalCoords;
}

layout(index = 1) subroutine (SubroutineGetNormal) vec3 getNormalMapNormal()
{
...
layout(location = 0) subroutine uniform SubroutineGetNormal subroutineGetNormal;

void main()
{
    vec3 normal = subroutineGetNormal();
