...
namespace
{
    auto subroutine_switch = [] (Scene& scene)
        {
            GLuint subroutines[] = { scene.getSubroutine() };
            scene.getSceneState().shaderProgram->SetSubroutines( GL_FRAGMENT_SHADER, 1, subroutines);
        };
}
            ...
            , 0.0019f }
{
    ...
    MakeAndAddSceneObject<CallbackDrawable<decltype(subroutine_switch)>>(subroutine_switch);
    AddSceneObject(modelLoader.Load(*this, "cyborg/cyborg.obj"));
