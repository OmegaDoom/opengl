...
public:
    ...
    GLuint getSubroutine() const { return m_subroutine; };
    void changeSubroutine(unsigned int value) { m_subroutine = value; };
private:
    template<typename T, typename ... Args>
    T& MakeSceneObject(Args&&... args);
    template<typename T, typename ... Args>
