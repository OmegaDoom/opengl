...
int main(int argc, char* argv[])
{
    ...
    textureManager.LoadTexture("resources/albedo.png", "albedo");
    textureManager.LoadTexture("resources/metallic.png", "metallic");
    textureManager.LoadTexture("resources/roughness.png", "roughness");
    textureManager.LoadTexture("resources/ao.png", "ao");
    textureManager.LoadTexture("resources/normal.png", "normal");
