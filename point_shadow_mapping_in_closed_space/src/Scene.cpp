    ...
    , m_lightView{ glm::lookAt(glm::vec3{ 0.f, 50.f, 0.f }, glm::vec3{ 0.f }, glm::vec3{ 0.f, 0.f, -1.f }) }
{
    ...
    m_lightInitialPositions.push_back(glm::vec4(0.f, 0.f, 5.f, 1.f));
    ...
    auto& woodTexture = textureManager["wood"];
    ...
    m_pipeline.Add(MakeAndAddSceneObject<ShadowMapTextureMaterialDrawable>(woodTexture, noneTexture, 1.f, cubemapShadowMapTexture), RenderPipeline::PASS1);
    ...
    auto& big_contTransform = MakeAndAddSceneObject<ModelNormalTransformDrawable>(glm::translate(glm::mat4{ 1.f } , glm::vec3{ 0.f, 0.0f, 0.f }));
    m_pipeline.Add(big_contTransform, RenderPipeline::PASS1);
    auto big_container_pass = [] (Scene& scene)
    {
        glCullFace(GL_FRONT);
    };
    m_pipeline.Add(MakeAndAddSceneObject<CallbackDrawable<CallbackDrawableFuncT>>(big_container_pass), RenderPipeline::PASS1);
    auto& big_container = MakeAndAddSceneObject<CubeDrawable>(10.0f);
    m_pipeline.Add(big_container, RenderPipeline::PASS1);
}
