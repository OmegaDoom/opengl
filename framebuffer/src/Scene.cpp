            ...
            , 0.0019f }
{
    ...
    MakeAndAddSceneObject<TextureMaterialDrawable>(framebufferTexture, container2spec, 1.f);
...
void Scene::Render() const
{
    ...
    for (int i = 0; i < m_drawables.size() - 1; ++i)
    {
       m_drawables[i].get().Render();
    }
