...
Texture2D::Texture2D(unsigned width, unsigned height, unsigned internalFormat
                    , unsigned minFilter, unsigned magFilter
                    , unsigned wrapS, unsigned wrapT)
    : Texture2D(internalFormat, minFilter, magFilter, wrapS, wrapT) 
{
