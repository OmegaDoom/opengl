...
void CubeDrawable::render() const
{
    ...
    m_shaderProgram->SetUniform("light.position", 0.f, 0.f, 0.f);
    m_shaderProgram->SetUniform("light.direction", 0.f, 0.f, -1.f); 
    m_shaderProgram->SetUniform("light.cutOff", glm::cos(glm::radians(12.5f))); 
    m_shaderProgram->SetUniform("light.outerCutOff", glm::cos(glm::radians(17.5f))); 
    ...
    m_shaderProgram->SetUniform("light.linear", 0.022f); 
    m_shaderProgram->SetUniform("light.quadratic", 0.0019f); 
