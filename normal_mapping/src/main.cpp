...
int main(int argc, char* argv[])
{
    ...
    textureManager.LoadTexture("./resources/brickwall_normal.jpg", "brickwallNormalMap");
    ...
    textureManager.LoadTextureS("./resources/brickwall.jpg", "brickwall", GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER);
    ...
    while(window.Process())
    {
        ...
        if (GLFW_PRESS == glfwGetKey(window.getPtr(), GLFW_KEY_SPACE))
        {
            scene.ChangePipeline();
        }
