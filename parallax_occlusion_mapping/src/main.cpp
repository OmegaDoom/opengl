...
int main(int argc, char* argv[])
{
    ...
    textureManager.LoadTexture("./resources/bricks2_normal.jpg", "bricksNormalMap");
    textureManager.LoadTexture("./resources/bricks2_disp.jpg", "bricksDisp");
    ...
    textureManager.LoadTextureS("./resources/bricks2.jpg", "bricks", GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER);
