...
void CubeDrawable::render() const
{
    ...
    //setting light
    auto viewLightDir = scene().getCamera().View() * m_lightTransform * glm::vec4(0.f, 0.f, 1.f, 0.f);
    m_shaderProgram->SetUniform("light.direction", viewLightDir.x, viewLightDir.y, viewLightDir.z);
