               ...
               , {glm::vec3{0.f}, glm::vec3{0.f, 0.f, 10.f}, glm::vec3{0}, 0.f}}
{
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        const auto quadSize = 1.f / std::pow(2, i);
        const auto quadOffset = -(2.f - quadSize) * 0.5f;
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        const int horGaussPass1 = 2 * pass;
