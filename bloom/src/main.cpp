...
int main(int argc, char* argv[])
{
    ...
    const auto FRAMEBUFFER_FORMAT = GL_RGB16F;
    textureManager.AddEmplace<Texture2D>("framebuffer0", 1, 1, FRAMEBUFFER_FORMAT, GL_NEAREST
                                , GL_NEAREST, GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER); 

    textureManager.AddEmplace<Texture2D>("framebuffer1", 1, 1, FRAMEBUFFER_FORMAT, GL_NEAREST
                                , GL_NEAREST, GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER); 

    textureManager.AddEmplace<Texture2D>("brightFramebuffer", 1, 1, FRAMEBUFFER_FORMAT, GL_NEAREST
                                , GL_NEAREST, GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER); 
