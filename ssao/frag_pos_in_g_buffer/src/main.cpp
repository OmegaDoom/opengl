...
int main(int argc, char* argv[])
{
    ...
    textureManager.AddEmplace<Texture2D>("noiseTexture", 4, 4, GL_RGBA16F, GL_NEAREST, GL_NEAREST, GL_REPEAT, GL_REPEAT);
    ...
    textureManager.AddEmplace<Texture2D>("ssaoColorFramebufferTex", 1, 1, GL_RED, GL_NEAREST
            , GL_NEAREST, GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER);
    textureManager.AddEmplace<Texture2D>("ssaoBlurFramebufferTex", 1, 1, GL_FLOAT, GL_NEAREST
            , GL_NEAREST, GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER);
