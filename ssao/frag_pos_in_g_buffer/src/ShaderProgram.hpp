...
public:
    ...
    bool SetUniformMatrices4(const char* name, int num, const float *matrix)
    {
        int location = glGetUniformLocation(m_shaderProgram, name);
        if (-1 == location)
            return false;
    ...
    bool SetUniform(const char* name, int count, const float *array)
    {
        int location = glGetUniformLocation(m_shaderProgram, name);
        if (-1 == location)
            return false;
    ...
    bool SetUniform3(const char* name, int count, const float *array)
    {
        int location = glGetUniformLocation(m_shaderProgram, name);
        if (-1 == location)
            return false;
